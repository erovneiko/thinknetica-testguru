...
class GistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post gists_url, params: { gist: { id: @gist.id, question_id: @gist.question_id, user_id: @gist.user_id } }
    end
  ...
  test "should update gist" do
    patch gist_url(@gist), params: { gist: { id: @gist.id, question_id: @gist.question_id, user_id: @gist.user_id } }
